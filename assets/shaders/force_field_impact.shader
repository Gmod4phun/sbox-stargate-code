...
PS
{
	...
	float4 g_vimpactColor < Attribute( "impactColor" ); Default4( 1.00, 1.00, 1.00, 1.00 ); >;
	float g_flimpactColorMul < Attribute( "impactColorMul" ); Default1( 1 ); >;
	float3 g_vimpactCenter < Attribute( "impactCenter" ); Default3( 0,0,-32 ); >;
	float g_flimpactRadius < Attribute( "impactRadius" ); Default1( 8 ); >;
