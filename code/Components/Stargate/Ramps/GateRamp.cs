namespace Sandbox.Components.Stargate.Ramps
{
	public class GateRamp : Component, Component.ExecuteInEditor
	{
		...
		public IEnumerable<Stargate> Gates =>
			GameObject.Components.GetAll<Stargate>(FindMode.InChildren);
		...
		public IEnumerable<ParticleEmitter> SmokeEmitters =>
			GameObject.Components.GetAll<ParticleEmitter>(FindMode.InChildren);
